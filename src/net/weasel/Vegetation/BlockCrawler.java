...
public class BlockCrawler {
	...
	public boolean withinEnabledBiome(Block b) {
		...
		if (biome == Biome.FOREST && settings.growForestBiome)
			return true;
		else if (biome == Biome.RAINFOREST && settings.growRainforestBiome)
			return true;
		else if (biome == Biome.PLAINS && settings.growPlainsBiome)
			return true;
		else if (biome == Biome.ICE_DESERT && settings.growIceDesertBiome)
			return true;
		else if (biome == Biome.DESERT && settings.growDesertBiome)
			return true;
		else if (biome == Biome.SWAMPLAND && settings.growSwamplandBiome)
			return true;
		else if (biome == Biome.TAIGA && settings.growTaigaBiome)
			return true;
		else if (biome == Biome.TUNDRA && settings.growTundraBiome)
			return true;
		else if (biome == Biome.SAVANNA && settings.growSavannahBiome)
			return true;
	 ...
	 * 
	 * @param baseBlock Location of the block the player is currently standing
	 * on
	 * 
	 * @param x
	 * 
	...
	/*
	 * gets a random block of specified material around the player. Block is on
	 * the surface
	 * 
	 * @param baseBlock Location of the block the player is currently standing
	 * on
	...
	/*
	 * gets a random block of specified material in give range around the
	 * player. Block is on the surface
	 * 
	 * @param baseBlock Location of the block the player is currently standing
	 * on
	 * 
	...
	/*
	 * checks whether give block (x) is surrounded by any block (+) of given
	 * material
	 * 
	 * @param block
	 * 
	...
	/*
	 * checks whether give block (x) is surrounded by any block (+) of give
	 * material
	 * 
	 * @param block
	 * 
	...
	/*
	 * checks whether a block is completely surrounded by blocks of give
	 * material
	 * 
	 * @param blocks
	 * 
	...
	public int getRandomRangeValue(int range) {
		...
		if ((retVal > 0) && (retVal > range))
			retVal = range;
		else if ((retVal < 0) && (retVal < range * -1))
			retVal = range * -1;
	...
	/*
	 * generates a density variable for give field of blocks formula is:
	 * (2*Range+1)^2 blocks
	 * 
	 * @param centerBlock
	 * 
